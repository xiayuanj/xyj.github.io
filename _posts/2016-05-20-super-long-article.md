...
author:
  - 夏元俊
---
## <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" style="width: 24px; height: 24px; vertical-align: middle; margin-right: 10px; fill: #59a9a7;"><path d="M0.853333 0.853333v1021.013334h1021.013334V0.853333H0.853333z m938.24 938.24H83.626667V83.626667h855.466666v855.466666zM718.250667 249.173333h110.378666v110.378667h-110.378666V249.173333zM194.048 194.048h220.757333v220.757333H194.048V194.048z m317.312 55.125333h110.378667v110.378667h-110.378667V249.173333zM194.048 745.984h331.136v82.816H194.048v-82.816z m0-193.237333h634.752v82.858666H194.048v-82.858666z" fill="#59a9a7"/></svg> 科研成果

## 期刊论文

[1] Xia Yuanjun, Tan Zhiyuan, Li Meng, Zhang Pengfei, Yu Lele, Dong Shi, Liu Yining*. [Communication-Efficient and Byzantine-Tolerant Federated Learning for Mobile Edge Computing](https://ieeexplore.ieee.org/document/xxxxxx){:target="_blank"}[J], IEEE Transactions on Mobile Computing（返修中）
...
**·** 董仕，夏元俊，于来行，张锦华，鲁硕，赵文清，夏钦宇. [基于深度迁移强化学习无线网络异常流量检测方法]{:target="_blank"}：CN202110866421.2[P].2023-04-07.（授权）

**·** 董仕，夏元俊. [基于区块链的边缘计算安全系统]{:target="_blank"}：CN202011042708.5[P].2022-08-12.（授权）

**·** 夏元俊，董仕，彭涛. [基于生成对抗深度卷积网络的流量识别方法]{:target="_blank"}：CN202110160578.3[P].2021-06-01.（公开）

**·** 董仕，夏元俊. [一种SSDDQN的网络异常流量检测方法]{:target="_blank"}：CN202110271456.1[P].2021-06-29.（公开）

**·** 董仕，夏元俊. [一种网络入侵检测方法、装置及设备]{:target="_blank"}：CN202110450303.3[P].2021-07-27.（公开）

**·** 夏钦宇，董仕，夏元俊，彭涛. [一种基于会话时空特征相残差的物联网设备识别模型]({:target="_blank"}：CN202210695834.3[P].2022-11-11.（公开）


## 科研项目

➢ 桂林电子科技大学，研究生科研创新项目，2023YCXB07，[联邦学习中的隐私保护聚合方法研究]{:target="_blank"}，2023-03至2025-03，2万元，结项，主持

➢ 温州市科技局，温州市重大科技创新攻关项目，ZG2023028，[数据要素与可信流通关键技术研究]{:target="_blank"}，2024-01至2026-12-31，300万元，在研，参与（8/9）

➢ 广西师范大学，教育部教育区块链与智能技术重点实验室研究项目，EBME24-F-M-03，[具有隐私保护的教育数据跨孤岛联邦学习研究]{:target="_blank"}，2024-05 至 2026-04，4万元，在研，参与（2/5）

➢ 广西壮族自治区信息中心，数字广西智慧基础设施联合创新实验室开放课题任务，GXDIOP2023003，[面向智慧城市数据要素的隐私计算关键技术研究]{:target="_blank"}，2024-01至 2025-12，20万元，在研，参与（6/11）

➢ 河南省教育厅，河南省教育厅科学技术研究重点项目，多视角特征降维技术在图像分类中的应用研究，22A520052，[多视角特征降维技术在图像分类中的应用研究]{:target="_blank"}，2022-01至 2023-12，3万元，结项，参与（6/6）



<style>
/* 合并样式：兼容home.html的样式，同时优化间距 */
.post-content h2 {
  font-size: 18px !important;    /* 同步home.html的18px，避免冲突 */
  font-weight: 600 !important;
  color: #333333 !important;
  margin: 20px 0 10px 0 !important;
  line-height: 1.2 !important;
}
/* 论文/专利/项目条目间距（和home.html联动） */
.post-content p, .post-content li {
  font-size: 16px !important;
  margin: 0 0 15px 0 !important; /* 每条底部15px间距，实现均匀分隔 */
  line-height: 1.7 !important;
  text-align: justify !important;
}
/* 链接样式（和home.html联动，避免冲突） */
.post-content a {
